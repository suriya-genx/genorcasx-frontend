...
const jobs = [
  ...
  { title: 'Cloud Architect', location: 'London, UK', type: 'Full-time' },
  { title: 'UI/UX Designer', location: 'Berlin, DE', type: 'Contract' },
]

export default function CareersSection() {
  return (
    <section id="careers" style={{ background: '#111', color: '#fff', padding: '5rem 0' }}>
      <div className="container d-flex flex-column flex-md-row align-items-center justify-content-between gap-5">
        <div style={{ flex: 1 }}>
          <h2 className="fw-bold mb-4" style={{ color: '#F2F9FF' }}>Careers at GenOrcasX</h2>
        ...
        <div style={{ flex: 1, textAlign: 'center' }}>
          <img src="/hire.png" alt="Quantum Bay Hiring" style={{ maxWidth: '100%', maxHeight: 220, objectFit: 'contain' }} />
        </div>
      </div>
    </section>
  )
